<template>
    <section style="padding-top: 3em; bottom: 0;">
        <footer class="footer is-primary fondo footer">
            <div>
                <span class="is-pulled-right has-text-white">
                    <img src="@/assets/logo.png" alt="logo" width="125px" style="border-radius: 20px;">
                </span>
                <p class="titulo content has-text-centered title is-3 has-text-white">
                    ...
                    <strong style="display:block; position: relative;font-size: 23px;">&#169 Bryan Andres</strong>
                </p>
            </div>
        </footer>
    </section>
